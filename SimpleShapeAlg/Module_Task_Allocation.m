...
function Task_Queue = Get_Module_From_The_Other_Side(First_Right,DestenationLine,Side,ReqiuerdType,totalDownwards,tempDownwards,Edges,AbsDiff)

if tempDownwards == totalDownwards
    NotCompleteLine = logical(flip(AbsDiff));
