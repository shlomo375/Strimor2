...
if Module_Num == 1
    ...
    Task = Module_Task_Allocation(StartConfig, TargetConfig, Downwards, TopLineIdx-1, "AlphaDiff_Override",1,"BetaDiff_Override",0,Side=Direction,totalDownwards=Tree.Total_Downwards);
    return
end
