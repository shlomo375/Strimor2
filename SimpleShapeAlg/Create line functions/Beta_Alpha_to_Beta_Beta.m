function [Step, Axis, Moving_Log_Top,Moving_Log_Mid,Moving_Log_Buttom,Task] = Beta_Alpha_to_Beta_Beta(Moving_Log_Top,Moving_Log_Mid,Moving_Log_Buttom,Edges,MovmentDirection,Downwards,Tree,TopLineIdx)
Step = [];
Axis = [];
Task = [];
...
if ~isempty(Edges)
    NotTested("Not Tested: Beta_Alpha_to_Beta_Beta")
    
    GroupSizeRequired = [4,-4];
