function [Step, Axis, Moving_Log_Top,Moving_Log_Mid,Moving_Log_Buttom,Task] = Create_Beta_Beta(Moving_Log_Top,Moving_Log_Mid,Moving_Log_Buttom,Edges,MovmentDirection,Downwards,Tree,CurrentLine,varargin)
Step = [];
Axis = [];
Task = [];
...
if ~isempty(Edges)
    ...
    [OK, Task] = PeripheralModuleExist(Tree,Downwards,CurrentLine,Edges,GroupSizeRequired,"Create");
    if ~OK
        return
    end
