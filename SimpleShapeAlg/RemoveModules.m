...
if numel(Decision) == 2 % Reduce module
    ...
    PlotStep = false;
    [WS, Tree, ParentInd] = Sequence_of_Maneuvers(WS,Tree,ParentInd,AllModuleInd,Moving_Log,Axis,Step,ConfigShift(:,1),"Plot",PlotStep);
...
%         ModuleTransitionData = NextMove(ModuleTransitionData,Direction);
    ...
    [WS, Tree, ParentInd , OK] = Sequence_of_Maneuvers(WS,Tree,ParentInd,AllModuleInd,Moving_Log,Axis,Step,ConfigShift(:,1),"Plot",false);
