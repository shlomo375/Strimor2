...
switch Dir
    case "Both"
        StepsLeft(1) = floor((Edges{2}{BaseNum_1st}(2,1)+(Edges{3}{BaseNum_1st}(2,1)==1) - Edges{3}{GroupNum}(2,1)+(Edges{3}{GroupNum}(2,1)==-1))/2);
        ...
        StepsRight(1) = floor((Edges{2}{BaseNum_1st}(2,2)+(Edges{3}{BaseNum_1st}(2,2)==1) - Edges{3}{GroupNum}(2,2)+(Edges{3}{GroupNum}(2,2)==-1))/2);
        if Edges{3}{GroupNum}(3,1) ~= -1 && Edges{2}{GroupNum}(3,1) ~= 1
    ...
    case "Left"
        ...
        Steps(1) = floor((Edges{2}{BaseNum_1st}(2,1)+(Edges{3}{BaseNum_1st}(2,1)==1) - Edges{3}{GroupNum}(2,1)+(Edges{3}{GroupNum}(2,1)==-1))/2);
        if Edges{3}{GroupNum}(3,1) ~= -1 && Edges{2}{GroupNum}(3,1) ~= 1
            Steps(1) = Steps(1) - 1;
    ...
    case "Right"
        Steps(1) = floor((Edges{2}{BaseNum_1st}(2,2)+(Edges{3}{BaseNum_1st}(2,2)==1) - Edges{3}{GroupNum}(2,2)+(Edges{3}{GroupNum}(2,2)==-1))/2);
        if Edges{3}{GroupNum}(3,1) ~= -1 && Edges{2}{GroupNum}(3,1) ~= 1
            Steps(1) = Steps(1) + 1;
            Steps(2) = 0;
        else
