...
switch MovmentDirection
    case "Left"
        Step = [Step, -1, 1,-1,-1, 1,-1, 1, 1];
        Axis = [Axis,  2, 3, 2, 3, 2, 1, 1, 2];
        Moving_Log(3,[3:4,end-(Buttom_Group_num-[1,2])]) = true;
        Moving_Log(4,[3:4,end-(Buttom_Group_num-1)]) = true;
        Moving_Log(5,2) = true;
        Moving_Log(6,[2:4,end-(Buttom_Group_num-1)]) = true;
        Moving_Log(7,[3:4,end-(Buttom_Group_num-[1,2])]) = true;
        Moving_Log(8,1:2) = true;
        Moving_Log(8,(end-(Buttom_Group_num-1)):end) = true;
        Moving_Log(9,1:4) = true;


    case "Right"
        Step = [Step, 1, -1, 1, 1, -1, 1, -1, -1];
        Axis = [Axis, 3,  2, 3, 2,  3, 1,  1, 3];
        
        Moving_Log(3,[Top_Group_num+Mid_Group_num-[0,1],end-[0,1]]) = true;
        Moving_Log(4,[Top_Group_num+Mid_Group_num-[0,1],end]) = true;
        Moving_Log(5,1) = true;
        Moving_Log(6,[1,Top_Group_num+Mid_Group_num-[0,1],end]) = true;
        Moving_Log(7,[Top_Group_num+Mid_Group_num-[0,1],end-[0,1]]) = true;
        Moving_Log(8,1:2) = true;
        Moving_Log(9,[1:2,Top_Group_num+Mid_Group_num-[0,1]]) = true;
