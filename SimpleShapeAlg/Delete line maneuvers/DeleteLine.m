...
% try
if ~matches(func2str(Decision),"Alpha_Alpha_Beta__1")
...
Maneuver_Cost = struct("Alpha_Alpha_Alpha__1",4,...
                       "Alpha_Alpha_Alpha__2",2000,...
                       ...
                       "Alpha_Alpha_Beta__1",1,...
                       "Alpha_Alpha_Beta__2",100,...
                       ...
                       "Alpha_Beta_Alpha__1",2,...
                       "Alpha_Beta_Alpha__2",100,...
                        ...
                       "Alpha_Beta_Beta__1",3,...
                       "Alpha_Beta_Beta__2",300);%,...
                        % ...
                        % ...
                        % ...
...
if Three_Line_Edges(3,1,4) ~= 1
    ...
    ManeuverRequired = str2func(join([LineEdgesRight.replace("-1","Beta").replace("1","Alpha"),string(abs(NumModule_TopLine))],"__"));
    Direction = "Right";
elseif Three_Line_Edges(3,2,4) ~= 1
    ...
    ManeuverRequired = str2func(join([LineEdgesLeft.replace("-1","Beta").replace("1","Alpha"),string(abs(NumModule_TopLine))],"__"));
    Direction = "Left";
else
