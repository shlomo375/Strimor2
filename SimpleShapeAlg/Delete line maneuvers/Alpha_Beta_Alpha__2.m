function [Step, Axis, Moving_Log_Top,Moving_Log_Mid,Moving_Log_Buttom] = Alpha_Beta_Alpha__2(ManuverHandle, Top_GroupInd,Mid_GroupInd,Buttom_GroupInd,Edges,Right_Left,Up_Down)
arguments
...
switch MovmentDirection
    ...
    case "Right"
        Step = [Step, 1];
        Axis = [Axis, 2];
        Moving_Log(3,[1:2,Top_Group_num+Mid_Group_num]) = true;
end
