function [Axis, Step, Moving_Log] = Beta_Beta_Beta__2(Moving_Log_Top,Moving_Log_Mid,Moving_Log_Buttom,Edges)
arguments
    Moving_Log_Top (:,:) {mustBeInteger,mustBeNumericOrLogical}
    Moving_Log_Mid (:,:) {mustBeInteger,mustBeNumericOrLogical}
    Moving_Log_Buttom (:,:) {mustBeInteger,mustBeNumericOrLogical}
    Edges = [];
end
